/**
*Tp7
*Questao06 - Hash Direta com Rehash
...
/**
*Metodo de transformacao para a hash
...
/**
*Metodo de transformacao para rehash
*@param id int - id da Pessoa 
*@return int - posicao na tabela correspondente a uma Pessoa com determinado id
*/
	public int rehash (int id){
		return (id + 1) % 21;
	}
...
*/
	public void inserir (Pessoa x){
		...
		if ( tabela[local].getId( ) == 0 ){
			...
			int novo = rehash(x.getId( ));
			compara ++;
			if ( tabela[novo].getId( ) == 0 ){
				tabela[novo] = x.clonar( );
			}
		}		
	}
...
public class TP07Q06HashRehash{
...
*/
	public static void fazerArquivo ( long inicio, long fim, int comparacoes){
		Arq.openWrite("553285_HashRehash.txt");
	...
	public static void main ( String [ ] args ){
		...
		HashRehash array = new HashRehash ( );		
		String linha;
		Pessoa inserida;
		Pessoa doarray = new Pessoa ( );
