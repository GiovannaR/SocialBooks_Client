/**
*Tp6
*Questao03 - Fila com alocacao flexivel
...
/**
*Metodo para inserir uma Pessoa no final da fila, deixando o tamanho sepre menor que 5
...
/**
*Metodo para remover uma Pessoa no inicio da Lista
...
*@return quantidade int - tamanho da fila
*/
	public int tamanho ( ){
		int quantidade = 0;
		try{
...
*@return mediaI int - media dos elementos da fila
*/
	...
	public static void main ( String [ ] args ){
		try{
			...
			while ( !linha.equals("FIM")){
				inserida = new Pessoa();
				inserida.ler( linha );
				fila.inserir (inserida);
				int media0 = fila.tirarMedia( );
				MyIO.println(media0);
				linha = MyIO.readLine( );
			}
			...
			while ( i < quantidade ){
				linha = MyIO.readLine( );
				if ( fila.isRemover(linha) ){
					fila.remover( );
				}else{
					Pessoa certa = doarray.Outros(linha); 
					fila.inserir (certa);
					int media1 = fila.tirarMedia( ); 
					MyIO.println (media1);
				}
				i ++;
			}			
