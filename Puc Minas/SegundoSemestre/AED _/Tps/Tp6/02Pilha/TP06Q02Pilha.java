/**
*Tp6
*Questao02 - Pilha com alocacao flexivel
...
/**
*Metodo para inserir uma Pessoa no final da pilha
...
/**
*Metodo para remover uma Pessoa no final da pilha
...
*/
	public Pessoa remover ( ) throws Exception{
		...
		Pessoa elemento = topo.elemento.clone( );;
		Celula tmp = topo;
		topo = topo.prox;
		tmp.prox = null;
		return elemento;
...
/**
*Metodo que inicia o metodo recursivo de imprimir os elementos da pilha em ordem crescente
*/
	public void imprimir ( ){
		imprimir(topo);
	}
...
/**
*Imprimir pessoas contidas no ponteiro em ordem crescente
*@param i Celula - Celula cujo elemento deve ser imprimido e que alimenta a recursividade ate' ser null
*/
...
/**
*Remover e retornar: (R) "nome da Pessoa removida"
*@return resposta String - (R) "nome da pessoa removida"
*/
	public String Removidos ( ) throws Exception{
		String resposta = "(R) ";
...
class TP06Q02Pilha{
	public static void main ( String [ ] args ){
		try{
			...
			while ( i < quantidade ){
				linha = MyIO.readLine( );
				if ( pilha.isRemover(linha) ){
					String imprimida = pilha.Removidos( );
