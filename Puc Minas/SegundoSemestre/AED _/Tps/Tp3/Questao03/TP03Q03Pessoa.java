/**
*Tp3
*Questao03 - Pilha com alocacao sequencial
*
	...
	public static void main ( String [ ] args ){
		...
		while ( i < quantidade ){
			...
			if ( pilha.isRemover(linha) ){
				String imprimida = pilha.Removidos(linha);
				MyIO.println(imprimida);
			}else{
				Pessoa certa = doarray.Outros(linha);
				pilha.qualMetodo (certa,linha);
			}
			i++;
		}
		pilha.imprimirArray( );
