...
/**
*Ir comparando com as posicoes do array ate' achar o int desejado
*@param x int - inteiro a ser procurado
...
*/
	public static void fazerArquivo ( long inicio, long fim, int comparacoes ){
		Arq.openWrite("553285_Sequencial.txt");
	...
	public static void main ( String [ ] args ){
		...
		while ( !linha.equals("FIM") ){
			...
			if ( lista.pesquisaSequencial(id) ){
				MyIO.println( "SIM" );
			}else{
				MyIO.println( "NAO" );
			}
