...
/**
*Metodo de ordenacao que percorre todos os elementos depois de um especifico, acha o menor de todos e substitui pelo especifico
*/
	public void selecao ( ){
		int i = 0;
		int menor = 0;
...
/**
*Pesquisa um elemento por meio de divisoes em um vetor ordenado ate' enconrar o elemento
*@param i int - inteiro a ser procurado
*@return resp boolean - se o inteiro se encontra ou nao no array
*/
...
*/
	public static void fazerArquivo ( long inicio, long fim, int comparacoes ){
		Arq.openWrite("553285_Binaria.txt");
	...
	public static void main ( String [ ] args ){
		...
		while ( !linha.equals("FIM") ){
			id = Integer.parseInt(doarray.SoDigito(linha));
			if ( lista.pesquisaBinaria(id) ){
				MyIO.println( "SIM" );
			}else{
				MyIO.println( "NAO" );
			}
		...
		long fim = now ( );
		fazerArquivo (inicio, fim, lista.getComparacoes( ));
	}
}
