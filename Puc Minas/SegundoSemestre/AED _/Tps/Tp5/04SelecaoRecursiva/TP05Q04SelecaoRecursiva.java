/**
*Tp5
*Questao04 - Ordenacao por Selecao
*
...
/**
*Metodo para chamas funcao recursiva
*/
...
/**
*Funcao recursiva que troca o menor elemento por um elemento especifico
*@param i int - posicao que se inicializara' a recursividade
*/
	public void selecaoRecursiva (int i){
		if ( i < (n - 1) ){
			int procuramenor = selecaoRecursiva(i, i + 1);
			swap( procuramenor, i );
...
/**
*Funcao recursiva que procura o menor elemento
*@param menor int - posicao do menor a ser comparado
*@param j int - posicao inicial para se percorrer o array em busca do menor
*/
	public int selecaoRecursiva ( int menor, int j ){
		int resp = menor;
		if ( j < n ){
			compara ++;
			...
			resp = selecaoRecursiva ( menor, j + 1 );
		}
		return resp;
	}
...
*/
	public static void fazerArquivo ( long inicio, long fim, int comparacoes, int movimentacoes ){
		Arq.openWrite("553285_selecaoRecursiva.txt");
